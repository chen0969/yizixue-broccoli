...
<section class="qaSection">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-3 qaCard row justify-content-between align-items-center">
            @php
            $category = $Data['QaCategory']->firstWhere('id', 1);
            @endphp
        ...
        <div class="col-3 qaCard row justify-content-between align-items-center">
            @php
            $category = $Data['QaCategory']->firstWhere('id', 2);
            @endphp
            <div class="col-8 d-flex flex-column h-100">
                <a class="categName" href="{{route('qna', ['category_id'=> $category->id])}}">
                    {{$category->name}}
        ...
        <div class="col-3 qaCard row justify-content-between align-items-center">
            @php
            $category = $Data['QaCategory']->firstWhere('id', 3);
            @endphp
            <div class="col-8 d-flex flex-column h-100">
                <a class="categName" href="{{route('qna', ['category_id'=> $category->id])}}">
                    {{$category->name}}
        ...
        <div class="col-3 qaCard row justify-content-between align-items-center">
            @php
            $category = $Data['QaCategory']->firstWhere('id', 5);
            @endphp
            <div class="col-8 d-flex flex-column h-100">
                <a class="categName" href="{{route('qna', ['category_id'=> $category->id])}}">
                    {{$category->name}}
        ...
        <div class="col-3 qaCard row justify-content-between align-items-center">
            @php
            $category = $Data['QaCategory']->firstWhere('id', 6);
            @endphp
            <div class="col-8 d-flex flex-column h-100">
                <a class="categName" href="{{route('qna', ['category_id'=> $category->id])}}">
                    {{$category->name}}
        ...
        <div class="col-3 qaCard row justify-content-between align-items-center">
            @php
            $category = $Data['QaCategory']->firstWhere('id', 7);
            @endphp
            <div class="col-8 d-flex flex-column h-100">
                <a class="categName" href="{{route('qna', ['category_id'=> $category->id])}}">
                    {{$category->name}}
